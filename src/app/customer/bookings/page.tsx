											...
											<div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 capitalize">
												<div className="flex items-center gap-2">
													...
													b.bookingStatus ===
														...
														<span
															className={`text-xs px-2 py-1 rounded-full ${b.paymentStatus === "paid" ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"} flex items-center gap-1 lowercase`}
														>
															{b.paymentStatus ===
															"paid" ? (
																<RiCheckDoubleLine
